        ...
        const mappedBabies = this.state.babies.map(baby => {
            ...
            return (
                <TabPanel className='tab-panel' key={`TabPanel${baby.baby_id}`}>
                    ...
                    <button className='delete-baby-button' onClick={(e) => { if (window.confirm('Are you sure you wish to delete this item?')) this.deleteBaby(baby.baby_id) } }>Delete Baby</button>
