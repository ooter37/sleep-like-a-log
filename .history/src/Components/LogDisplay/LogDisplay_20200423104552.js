...
export default class LogDisplay extends React.Component {
    ...
    extractor(array) {
        ...
        for (let i = 0; i < splitAsleep.length; i++) {
            console.log(splitAwake[i][1])
            console.log(splitAsleep[i][1])
          subtracted.push([
            splitAsleep[i][0],
            parseInt((moment.duration(moment("2020-04-20T17:40:00.621Z").diff(moment("2020-04-20T16:00:00.621Z")))).asMinutes())
