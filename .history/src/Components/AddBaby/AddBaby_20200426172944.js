    ...
    render() {
        ...
        return (
            <div className='add-baby'>
                ...
                onClick={() => { if (this.state.babyName !== '' && this.state.relationship) {if (window.confirm(`Name: ${this.state.babyName} Relationship: ${this.state.relationship} Is this correct?`)) {
                    this.addBaby()
                }}}
            }
                >Add Baby</button>
