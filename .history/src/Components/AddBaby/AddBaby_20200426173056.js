    ...
    render() {
        ...
        return (
            <div className='add-baby'>
                ...
                onClick={() => { if (this.state.babyName !== '' && this.state.relationship) {if (window.confirm(`Would you like to add ${this.state.babyName}, with a relationshup of ${this.state.relationship}?`)) {
                    this.addBaby()
                }}}
            }
                >Add Baby</button>
