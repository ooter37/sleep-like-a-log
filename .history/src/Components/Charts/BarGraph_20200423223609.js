...
export default class BarGraph extends React.Component {
  ...
  render() {
    console.log(moment.utc().subtract(1,'days').format().slice(0,10))
    // const date0 = new Date();
    const today = moment.utc().format().slice(0,10)
      // date0.getFullYear() +
      // "-" +
    ...
    const minusOne = moment.utc().subtract(1,'days').format().slice(0,10)
      // date1.getFullYear() +
      // "-" +
    ...
    const minusTwo = moment.utc().subtract(2,'days').format().slice(0,10)
    //   date2.getFullYear() +
    //   "-" +
    ...
    const minusThree = moment.utc().subtract(3,'days').format().slice(0,10)
    //   date3.getFullYear() +
    //   "-" +
    ...
    const minusFour = moment.utc().subtract(4,'days').format().slice(0,10)
      // date4.getFullYear() +
      // "-" +
