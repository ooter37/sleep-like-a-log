...
export default class Test extends React.Component {
  ...
  extractor(array) {
    ...
    for (let i = 0; i < splitAsleep.length; i++) {
      subtracted.push([
        splitAsleep[i][0],
        moment.utc(moment.duration(moment(splitAwake[i]).diff(moment(splitAsleep[i])), "milliseconds").asMilliseconds()).format("HH:mm")
      ]);
    }
    // console.log(splitAsleep, splitAwake);
    console.log(subtracted)
    console.log(moment.utc(moment.duration(moment("2020-04-20T16:00:00.621Z").diff(moment("2020-04-20T17:00:00.621Z")), "milliseconds").asMilliseconds()).format("HH:mm"))
  }
  render(){
